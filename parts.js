...
export const PARTS = [
  ...
  { id: 'gear-8', name: 'Gear 8T', category: 'Gears', icon: '⚙', description: 'Small spur gear', defaultColor: 0xadb5bd, connectors: [{ id: 'axle-hole', type: 'axle-hole', position: [0, 0.4, 0], axis: [0, 1, 0] }], create: c => createGear('gear-8', 8, c) },
  { id: 'gear-16', name: 'Gear 16T', category: 'Gears', icon: '⚙', description: 'Medium spur gear', defaultColor: 0xd9d9d9, connectors: [{ id: 'axle-hole', type: 'axle-hole', position: [0, 0.4, 0], axis: [0, 1, 0] }], create: c => createGear('gear-16', 16, c) },
  { id: 'gear-24', name: 'Gear 24T', category: 'Gears', icon: '⚙', description: 'Large spur gear', defaultColor: 0xd9d9d9, connectors: [{ id: 'axle-hole', type: 'axle-hole', position: [0, 0.4, 0], axis: [0, 1, 0] }], create: c => createGear('gear-24', 24, c) },
  { id: 'wheel', name: 'Off-road Wheel', category: 'Wheels', icon: '◉', description: 'Large prototype wheel', defaultColor: 0xb7bcc3, connectors: [{ id: 'axle-hole', type: 'axle-hole', position: [0, 1.15, 0], axis: [1, 0, 0] }], create: c => createWheel('wheel', c) },
  { id: 'motor', name: 'Lab Motor', category: 'Power', icon: 'M', description: 'Drivetrain motor placeholder', defaultColor: 0x6f7680, connectors: [{ id: 'output', type: 'axle', position: [1.75, 0.9, 0], axis: [1, 0, 0] }], create: c => createMotor('motor', c) },
]
