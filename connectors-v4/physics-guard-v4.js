...
} from '../technic/rack-pinion-physics-v1.js?v=technic-rack-pinion-physics-20260916-v2'
...
function rebuildDrivetrainSemanticsV4(session, records) {
  ...
  session.drivetrain = analyzeTechnicAwareDrivetrain(session.objects, semanticConnections)
