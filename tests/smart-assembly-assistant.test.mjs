...
test('production bootstrap never blocks the established editor UI on Smart Assembly', async () => {
  ...
  const assistant = source.indexOf("./guidance/smart-assembly-activation-v1.js?v=smart-assembly-20260911-v1")
  assert.ok(adapter >= 0)
  ...
  assert.match(activation, /smart-assembly-runtime-v1\.js\?v=smart-assembly-20260911-v3/)
