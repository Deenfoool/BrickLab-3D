import { mountPartsLibrary, LIBRARY_KEYS } from '../ldraw/library-view-v1.js?v=parts-library-20260912-v4'
import { libraryItems } from '../ldraw/library-model-v1.js?v=parts-library-20260912-v4'
const fixtures=[
