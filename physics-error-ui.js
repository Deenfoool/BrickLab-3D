const BUILD_ID = 'PHYSICS-7'
const BUILD_TAG = 'physics-7-20260908-1515'
...
function installBuildStamp() {
  ...
  badge.title = `BrickLab production build ${BUILD_TAG} · clearance-aware colliders · open Technic holes · SI boundary · Connector System v3`
