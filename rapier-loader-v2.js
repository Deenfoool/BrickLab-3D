...
export async function createRapierBaseSession(objects, connections, options = {}) {
  let RAPIER
  ...
  try {
    ...
    session.mechanicsNextBaseInfrastructure = session.mechanicsNextBootstrap
...
PhysicsSession.create = createRapierBaseSession
