...
if(!/<script type="importmap">[\s\S]*?<\/script>/.test(html))throw new Error('index.html production import map was not found')
...
for (const file of ['physics-error-ui.js','tests/production-importmap-loader.js','tests/time-scale-browser.html','audio-qa.html']) {
