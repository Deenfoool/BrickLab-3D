...
const RU = Object.freeze({
  'universal-joint-30': ['Кардан 30°', 'Шарнирный карданный привод 1:1 со сферическим соединением выходного вала'],
  ...
  'steering-rack-guide': ['Направляющая рулевой рейки', 'Крепящаяся к шасси линейная направляющая рулевой рейки'],
  'steering-rack-7': ['Рулевая рейка 7L', 'Подвижная рулевая рейка 7L с левым и правым пальцами рулевых тяг'],
  'shock-body-5': ['Корпус амортизатора 5L', 'Нижняя часть телескопического пружинного амортизатора'],
  'shock-rod-5': ['Шток амортизатора 5L', 'Верхний телескопический шток с пружиной и монтажным отверстием'],
})
